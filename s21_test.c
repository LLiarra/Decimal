...
START_TEST(s21_round_negative_integer) {
  ...
  s21_decimal value = {0};
  value.bits[0] = 12;
  s21_decimal test = {{12}}; set_sign(&value);
  int s21_result = s21_round(value, &result);
  ck_assert_int_eq(result.bits[0], test.bits[0]);
...
Suite* s21_decimal_suite() {
  ...
  TCase *tc_mul, *tc_is_less, *tc_is_equal, *tc_is_less_or_equal, *tc_decimal_float,
  *tc_sub, *tc_div, *tc_mod, *tc_int_dec, *tc_floor, *tc_not_equal, *tc_sum, *tc_truncate,
  *tc_negate, *tc_round, *tc_is_greater, *tc_is_greater_or_equal, *tc_float_dec;
