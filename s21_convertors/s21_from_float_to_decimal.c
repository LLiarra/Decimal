...
int s21_from_float_to_decimal(float src, s21_decimal *dst) {
  int wrong_arg = src == S21_POSITIVE_INF || src == S21_NEGATIVE_INF || src != src || dst == NULL;
  ...
  src_work *= powl((long double)10.0, (long double)(28.0 - exp));  //  получаем src домноженный до 28 знаков
  char bit[128] = {'\0'};
