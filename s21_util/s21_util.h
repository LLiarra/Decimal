...
s21_decimal s21_normalize_after_div(s21_decimal result_dif, int power_1, int power_2);
s21_decimal s21_base_bank_round(s21_decimal last_decimal, s21_decimal pre_digit, s21_decimal result);
...
s21_decimal s21_int_div(s21_decimal value_1, s21_decimal value_2, s21_decimal* result);
